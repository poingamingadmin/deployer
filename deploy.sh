...
apt install -y php${PHP_VERSION} php${PHP_VERSION}-cli php${PHP_VERSION}-mbstring php${PHP_VERSION}-xml php${PHP_VERSION}-fpm php${PHP_VERSION}-bcmath php${PHP_VERSION}-gd php${PHP_VERSION}-curl php${PHP_VERSION}-zip php${PHP_VERSION}-mysql php${PHP_VERSION}-redis php${PHP_VERSION}-fpm unzip nginx mysql-server git curl certbot python3-certbot-nginx
